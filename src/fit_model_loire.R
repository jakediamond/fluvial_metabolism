...
df_data <- read_fun(file.path("data", "loire", "loire_clean.xlsx")) |>
  filter(site == "Dampierre") |>
  mutate(datestart = "2019-06-10", dateend = "2019-06-10") |> #3/10 before
  mutate(
...
parms_test_o2 <- c(K600 = 4, O2_l = 0.2, qL = 4.6E-5,
                   gpp_mean = 2.35, er_mean = 5.7)
plower_o2 <- c(K600 = 0.5, O2_l = 0.01, qL = 1E-5,
               gpp_mean = 1, er_mean = 1)
pupper_o2 <- c(K600 = 6, O2_l = 0.2, qL = 1E-4,
               gpp_mean = 20, er_mean = 20)
...
# sum(costs)
# sum((dat[-1] - out1[-1])^2)
parms_test <- c(K600 = 4, DIC_l = 2.3, ALK_l = 2.3, O2_l = 0.2, qL = 4.6E-5,
                gpp_mean = 2.35, er_mean = 5.7, PQ = 0.95, RQ = 1.1)
plower    <- c(K600 = 0.5, DIC_l = 0.5, ALK_l = 0.5, O2_l = 0, qL = 1E-5,
               gpp_mean = 1, er_mean = 1, PQ = 0.8, RQ = 0.8)
pupper    <- c(K600 = 6, DIC_l = 3, ALK_l = 3, O2_l = 0.4, qL = 1E-3,
               gpp_mean = 15, er_mean = 15, PQ = 1.5, RQ = 1.5)
